...
class WideResNet:
    def __init__(self, image_size, depth=16, k=8):
        self._depth = depth
        self._k = k
        self._dropout_probability = 0.01
        ...
        def f(net):
            ...
            for i, v in enumerate(conv_params):
                if i == 0:
                    ...
                    convs = Conv2D(n_bottleneck_plane, kernel_size=(v[0], v[1]), strides=v[2], padding=v[3],
            ...
            if n_input_plane != n_output_plane:
                shortcut = Conv2D(n_output_plane, kernel_size=(1, 1), strides=stride, padding="same",
                                  kernel_initializer=self._weight_init, kernel_regularizer=l2(self._weight_decay),
    ...
    def __call__(self):
        ...
        conv1 = Conv2D(filters=n_stages[0], kernel_size=(3, 3), strides=(1, 1), padding="same",
                       kernel_initializer=self._weight_init, kernel_regularizer=l2(self._weight_decay),
